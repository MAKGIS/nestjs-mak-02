...
export declare type RangeFilterValue = [number, number];
export declare type ListFilterValue = string[];
...
export declare type Filter = CategoryFilter | RangeFilter | CheckFilter | ColorFilter | RadioFilter;
export {};
